...
4. "realize uma auditoria adversarial de corretude e de testes no sistema de pagamentos"
5. "gere um relatório profundo de bugs reais e avalie os testes"
6. "busque memory leaks e resource exhaustions no projeto"
7. "faça uma caça a bugs de segurança e audite a qualidade dos nossos testes"
8. "analise os testes da aplicação, verifique eficácia e gaps, e cruze com bugs"
9. "varra o projeto em busca de erros no manuseio de dinheiro e classifique o risco dos domínios testados"
10. "quero um report rigoroso dos bugs da aplicação e o dashboard de testes em markdown"
